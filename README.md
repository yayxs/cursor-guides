...
Cursor每人每月的20美元Pro，已经没有了500次数计费的方式，取而代之的是一个黑箱计费模式。这是新的收费规则：⬇️

[1] 完全基于 token ，和大语言模型的计费方式一致，所谓的api的方式。保证你所有的token加起来大于20美元，看起来你赚了。

[2] 分为 token _ 1 和 token _ 1.2。不管哪个模型只要开启 Max Mode 就是 乘以1.2 。

[3] claude-4-opus-thinking、claude-4-opus 和 o3-pro这3个 必须是乘以 1.2。因为只有开Max Mode才能用这仨。

[4] 每月出账单，奇了怪了，怎么大于20美元？不要问，问就是你订阅了Pro，值，值。物超所值。
